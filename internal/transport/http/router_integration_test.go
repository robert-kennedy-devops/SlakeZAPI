...
func (f *fakeWhatsAppService) Connect(ctx context.Context, tenantID, instanceID string) (string, error) {
	f.status = domain.SessionStatusConnecting
	f.session = &domain.Session{TenantID: tenantID, InstanceID: instanceID, Status: f.status}
	return "qr-test", nil
}

func (f *fakeWhatsAppService) Disconnect(ctx context.Context, tenantID, instanceID string) error {
	f.status = domain.SessionStatusDisconnected
	return nil
}

func (f *fakeWhatsAppService) Logout(ctx context.Context, tenantID, instanceID string) error {
	f.status = domain.SessionStatusDisconnected
	f.session = nil
	return nil
}

func (f *fakeWhatsAppService) SendMessage(ctx context.Context, tenantID, instanceID, phone, message string) (string, error) {
	return "wa-text-1", nil
}

func (f *fakeWhatsAppService) SendMediaMessage(ctx context.Context, tenantID, instanceID string, req domain.SendMediaMessageRequest) (string, error) {
	return "wa-media-1", nil
}

func (f *fakeWhatsAppService) SendInteractiveMessage(ctx context.Context, tenantID, instanceID string, req domain.InteractiveMessageRequest) (string, error) {
	return "wa-interactive-1", nil
}

func (f *fakeWhatsAppService) SendGroupMessage(ctx context.Context, tenantID, instanceID string, req domain.GroupMessageRequest) (string, error) {
	return "wa-group-1", nil
}

func (f *fakeWhatsAppService) PostStatus(ctx context.Context, tenantID, instanceID string, req domain.StatusMessageRequest) (string, error) {
	return "wa-status-1", nil
}

func (f *fakeWhatsAppService) ListGroups(ctx context.Context, tenantID, instanceID string) ([]domain.Group, error) {
	return []domain.Group{
		{
...
func (f *fakeWhatsAppService) ResolveContacts(ctx context.Context, tenantID, instanceID string, phones []string) ([]domain.ResolvedContact, error) {
...
func (f *fakeWhatsAppService) DownloadMedia(ctx context.Context, tenantID, instanceID string, msg *domain.Message) (*domain.MediaDownload, error) {
...
func (f *fakeWhatsAppService) GetSession(ctx context.Context, tenantID, instanceID string) (*domain.Session, error) {
	if f.session == nil {
...
func (f *fakeWhatsAppService) GetStatus(ctx context.Context, tenantID, instanceID string) domain.SessionStatus {
	return f.status
}
...
func newIntegrationServer(t *testing.T, db *sql.DB) http.Handler {
	...
	authUC := usecase.NewAuthUsecase(apiKeyRepo, tenantRepo, instanceRepo, subRepo, billingSvc, waSvc, "test-salt", log)
	userAuthUC := usecase.NewUserAuthUsecase(userRepo, tenantRepo, instanceRepo, tenantUserRepo, userSessionRepo, subRepo, 15*time.Minute, 7*24*time.Hour, log)
